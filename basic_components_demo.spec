# RPM package for basic_components_demo
...
%__install -m 644 basic_components_demo.sad.xml $RPM_BUILD_ROOT%{_prefix}/dom/waveforms/%{name}/basic_components_demo.sad.xml

%files
%defattr(-,redhawk,redhawk)
%dir %{_prefix}/dom/waveforms/%{name}
%{_prefix}/dom/waveforms/%{name}/basic_components_demo.sad.xml
